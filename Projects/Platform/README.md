...
| BOARD_InitENET         | F14 | GPIO1      | gpio_io, 09 | USER_LED           | Direction Output, GPIO initial state 1, mode PullUp | Ethernet KSZ8081RNB pin RST (GPIO_B0_09)
| BOARD_InitENET         | G13 | GPIO1      | gpio_io, 10 | INT1_COMBO         | Direction Output, GPIO initial state 1, mode PullUp | Ethernet KSZ8081RNB pin INT (GPIO_B0_10)
